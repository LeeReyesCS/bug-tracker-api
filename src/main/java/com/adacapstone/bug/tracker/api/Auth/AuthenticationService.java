...
import com.adacapstone.bug.tracker.api.Config.JwtService;
import com.adacapstone.bug.tracker.api.User.Role;
...
public class AuthenticationService {
    ...
    //allows us to create user, save to database and return saved token
